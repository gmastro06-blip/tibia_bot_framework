...
def main() -> None:
    ...
    data = repo_root / "datasets" / "temp_creatures" / "tibia-creatures_v1_yolov8" / "data.local.yaml"
    if not data.exists():
    ...
    try:
        ...
        if torch.cuda.is_available():
            try:
                ...
                # Common on Windows: torchvision built without CUDA ops.
